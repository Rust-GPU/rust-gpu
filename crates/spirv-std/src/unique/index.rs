...
///
/// # Safety
/// The index must be unique within the [`ActiveInvocations`] scope.
...
///
/// # Safety
/// The index must be unique within the [`Scope`] `S`.
